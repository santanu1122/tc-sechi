...
#import "SEClientAddViewController.h"

#import "SEClient.h"
#import "SETextFieldTableViewCell.h"
#import "UIView+Hierarchy.h"

@interface SEClientAddViewController ()
 ...
 */
@property (strong, nonatomic) SETextFieldTableViewCell* companyCell;
...
@property (strong, nonatomic) SETextFieldTableViewCell* emailCell;
@property (strong, nonatomic) SETextFieldTableViewCell* addressCell;

@end

@implementation SEClientAddViewController
...
- (void) saveButtonTouchedUpInside: (id) sender {
    ...
    self.client = [NSEntityDescription insertNewObjectForEntityForName:NSStringFromClass([SEClient class])
