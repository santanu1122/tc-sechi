...
class SEGalleryViewController: SEViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
	 ...
	 */
	init(mediaFilesArray mediaFiles: [], atIndex index: Int) {
	 ...
	 *  @return initialized view controller on success, nil on failure
	 */
	convenience init(mediaFilesArray mediaFiles: []) {
	...
	func viewDidLoad() {
	    ...
	    var background = UIImageView(image: UIImage.imageNamed("bg.png"))
	    ...
	    var lineView = UIImageView(image: UIImage.imageNamed: "line_schedule"))
	...
	func pageViewController(pageViewController: UIPageViewController, viewControllerAfterViewController viewController: UIViewController) -> UIViewController {
	    var currentIndex = self.mediaFiles.indexOfObject:((SEPhotoViewController*)viewController).jobPhotoInfo];
