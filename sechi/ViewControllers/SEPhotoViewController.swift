...
class SEPhotoViewController: SEViewController, UIScrollViewDelegate {
	...
	override func updateViewConstraints() {
	    ...
	    self.view.addConstraints(NSLayoutConstraint(visualFormat: "H:|[scrollView]|", options: nil, metrics: nil, views:viewsDictionary))
	    self.view.addConstraints(NSLayoutConstraint(visualFormat: "V:|[scrollView]|", options: nil, metrics: nil, views:viewsDictionary))
	    self.view.addConstraints(NSLayoutConstraint(visualFormat: "H:|[imageView(width)]", options: nil, metrics: ["width": self.view.frame.size.width], views: viewsDictionary))
	    self.view.addConstraints(NSLayoutConstraint(visualFormat: "V:|[imageView(height)]", options: nil, metrics: ["height": self.view.frame.size.height], views: viewsDictionary))
	}
